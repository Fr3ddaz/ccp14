...
public final class AArrayConstructPrimaryExpr extends PPrimaryExpr
{
    private TNew _new_;
    private TId _id_;
    ...
    public AArrayConstructPrimaryExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayConstructPrimaryExpr(
    ...
    {
        ((Analysis) sw).caseAArrayConstructPrimaryExpr(this);
    }
