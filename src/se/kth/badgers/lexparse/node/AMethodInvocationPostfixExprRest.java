...
public final class AMethodInvocationPostfixExprRest extends PPostfixExprRest
{
    private TDot _dot_;
    private TId _id_;
    ...
    public AMethodInvocationPostfixExprRest()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMethodInvocationPostfixExprRest(
    ...
    {
        ((Analysis) sw).caseAMethodInvocationPostfixExprRest(this);
    }
